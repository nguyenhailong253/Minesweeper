...
public class MineFieldValidatorTest {
    ...
    public static class TestValidateContentOf2DStringArray {
        private static final String VALID_SQUARE = Constants.VALID_SQUARE;

        @Test
        public void shouldReturnTrue_WhenReceiveStringArrayWithAsterisksAndDotsAndSingleDigitNumber() {
            String[][] validStrings = new String[][]{{".", "9", "*"}, {".", "0", "*"}};

            boolean validStringArrays = MineFieldValidator.validateContentOf2DStringArray(validStrings, VALID_SQUARE);

            Assert.assertTrue(validStringArrays);
        }

        @Test
        public void shouldReturnTrue_WhenReceiveStringArrayWithAllAsterisks() {
        ...
        @Test
        public void shouldReturnTrue_WhenReceiveStringArrayWithAllDots() {
            String[][] validStrings = new String[][]{{".", ".", "."}, {".", ".", "."}};
        ...
        @Test
        public void shouldReturnTrue_WhenReceiveStringArrayWithAllSingleDigitNumber() {
            String[][] validStrings = new String[][]{{"1", "0", "2"}, {"0", "9", "5"}};
        ...
        @Test
        public void shouldReturnFalse_WhenReceiveStringArrayWith2DigitsNumber() {
            String[][] validStrings = new String[][]{{".", "90", "*"}, {".", "10", "*"}};

            boolean validStringArrays = MineFieldValidator.validateContentOf2DStringArray(validStrings, VALID_SQUARE);

            Assert.assertFalse(validStringArrays);
        }

        @Test
        public void shouldReturnFalse_WhenReceiveStringArrayWithAtLeast2CharactersPerString() {
            String[][] validStrings = new String[][]{{"..", "..", "**"}};
        ...
        @Test
        public void shouldReturnFalse_WhenReceiveStringArrayWithEmptyString() {
            String[][] validStrings = new String[][]{{""}, {""}};
